  ...
  return (
    <footer className="bg-slate-900 text-slate-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-slate-400">navjyotsinghpulaha@gmail.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="h-5 w-5 text-indigo-400" />
                <span className="text-slate-400">+91 9930834826</span>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin className="h-5 w-5 text-indigo-400" />
                <span className="text-slate-400">Anant Regency, phase 2, A wing, 305, Rambaug 4, Kalyan (W)</span>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Copyright */}
        <div className="mt-8 border-t border-slate-800 pt-4 text-center pb-5">
